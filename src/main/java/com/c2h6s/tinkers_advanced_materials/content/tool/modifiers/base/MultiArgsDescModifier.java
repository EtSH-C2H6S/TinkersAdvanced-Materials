...
public abstract class MultiArgsDescModifier extends EtSTBaseModifier implements IHaveConfigToInit{
    ...
    public static void initializeConfig(){
        ...
        ModifierManager.INSTANCE.getAllValues().filter(modifier -> modifier instanceof IHaveConfigToInit)
                .forEach(modifier -> {
                    ((IHaveConfigToInit) modifier).refreshConfig();
