...
import static com.c2h6s.etstlib.util.ParticleContext.readParticleOption;
...
public class PParticleRingS2C {
    ...
    public PParticleRingS2C(FriendlyByteBuf byteBuf){
        this(byteBuf.readFloat(),byteBuf.readFloat(),new Vec3(byteBuf.readVector3f()),readParticleOption(byteBuf.readById(BuiltInRegistries.PARTICLE_TYPE),byteBuf),byteBuf.readFloat());
    }
