...
public enum EnumMaterial {
    BISMUTH(true,TiAcMeMaterialIds.BISMUTH,3,false,false,EnumMaterialStats.BISMUTH,noopCompat(true),EnumMaterialModifier.BISMUTH),
    BISMUTHINITE(true,TiAcMeMaterialIds.BISMUTHINITE,2,true,false,EnumMaterialStats.BISMUTHINITE,noopCompat(true),EnumMaterialModifier.BISMUTHINITE,BISMUTHINITE_FLUX_CORE,BISMUTHINITE_AMMO,BISMUTHINITE_ARMOR),
    ...
    STIBNITE(true,TiAcMeMaterialIds.STIBNITE,4,true,false,EnumMaterialStats.STIBNITE,noopCompat(true), STIBNITE_DEFAULT,STIBNITE_FLUX_CORE,STIBNITE_AMMO,STIBNITE_ARMOR),
    ALLOY_ATOMIC(TiAcMeMaterialIds.Mekanism.ALLOY_ATOMIC,4,true,false,EnumMaterialStats.ALLOY_ATOMIC, tagFilled(MekanismTags.Items.ALLOYS_ATOMIC,"mekanism",false),EnumMaterialModifier.ALLOY_ATOMIC),
    FLUIX(TiAcMeMaterialIds.AE2.FLUIX,2,true,false,EnumMaterialStats.FLUIX, tagFilled(ConventionTags.FLUIX_CRYSTAL,"ae2",false),FLUIX_ARMOR,FLUIX_BINDING,FLUIX_GRIP,FLUIX_HEAD,FLUIX_HANDLE,FLUIX_LIMB, FLUIX_FLUX_CORE,FLUIX_AMMO),
    CERTUS(TiAcMeMaterialIds.AE2.CERTUS,1,true,false,EnumMaterialStats.CERTUS, tagFilled(ConventionTags.CERTUS_QUARTZ,"ae2",false),CERTUS_ARMOR,CERTUS_DEFAULT,CERTUS_AMMO),
    ...
    IRRADIUM(true,TiAcMeMaterialIds.Mekanism.IRRADIUM,5,false,false,EnumMaterialStats.IRRADIUM,modLoaded("mekanism",true),IRRADIUM_DEFAULT,IRRADIUM_ARMOR),
    PNEUMATIC_STEEL(true,TiAcMeMaterialIds.PnC.PNEUMATIC_STEEL,4,true,false,EnumMaterialStats.PNEUMATIC_STEEL,modLoaded("pneumaticcraft",true),PNEUMATIC_STEEL_ARMOR,PNEUMATIC_STEEL_DEFAULT,PNEUMATIC_STEEL_AMMO),
    ...
    ACTIVATED_CHROMATIC_STEEL(true,TiAcMeMaterialIds.Thermal.ACTIVATED_CHROMATIC_STEEL,5,false,false,EnumMaterialStats.ACTIVATED_CHROMA_STEEL,modLoaded("thermal",true),ACTIVATED_CHROMA_STEEL_MELEE,ACTIVATED_CHROMA_STEEL_ARMOR,ACTIVATED_CHROMA_STEEL_RANGED),
    ...
    IRIDIUM(true,TiAcMeMaterialIds.IRIDIUM,5,false,false,EnumMaterialStats.IRIDIUM,noopCompat(true), IRIDIUM_DEFAULT,IRIDIUM_ARMOR,IRIDIUM_FLUX_CORE),
